...
/**
 * Unified NFT Gallery component for displaying and selecting NFTs
 * Supports both user-owned and external wallet NFTs with lazy loading
 */
export function UnifiedNFTGallery({
  ...
  // Lazy load state to improve performance for large NFT collections
  ...
  // Don't render anything if no NFTs and still loading
  if (nfts.length === 0) {
    return null;
  }

  /**
   * Scrolls the NFT gallery horizontally
   */
